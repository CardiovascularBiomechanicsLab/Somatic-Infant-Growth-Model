...
% Outputs:
%   dimensions: LV (1)EDV, (2)ESV, (3)ED thickness, (4)ES thickness, (5)Vwall (thicknesses converted to mm)
%   ValuesofInt: (1)EDP (2)EDV (3)MaxP (4)MAP (5)maxV (6)minV (7)HR (8)ESP (9)ESV
%   dimensions_R: RV (1)EDV, (2)ESV, (3)ED thickness, (4)ES thickness, (5)Vwall (thicknesses converted to mm)
%   ValuesofInt_R: (1)EDP (2)EDV (3)MaxP (4)MAP (5)maxV (6)minV (7)HR (8)ESP (9)ESV
        

%ValuesofInt: (1)EDP (2)EDV (3)MaxP (4)MAP (5)maxV (6)minV (7)HR (8)ESP (9)ESV
ValuesofInt=zeros(9,  1*logical(growthstep>0)+logical(growthstep<1)*iteration_growth_max);
ValuesofInt_R=zeros(9,  1*logical(growthstep>0)+logical(growthstep<1)*iteration_growth_max);
...
if HLHS == 1
    ...
    ValuesofInt(9,1)=Volumes(row_AV_closes,3);
end
...
ValuesofInt(8,1)=ESP_model;
ValuesofInt_R(8,1)=ESP_model_R;
...
%dimensions: EDV, ESV, ED thickness, ES thickness, Vwall (thicknesses converted to mm)   
...
ValuesofInt(7,1)=60/max(TimeVector);
ValuesofInt_R(7,1)=60/max(TimeVector);

% Actual ESV
ValuesofInt_R(9,1) = Volumes(row_PV_closes,10);
